...
@include('tomato-eddy::components.server.site-tls-snippet', ['tlsSetting' => $site->tls_setting])
...
{!! $site->address !!}:{!! $site->port !!} {
    ...
    @if($site->type !== \TomatoPHP\TomatoEddy\Enums\Models\SiteType::Static)
    ...
    @if($site->type === \TomatoPHP\TomatoEddy\Enums\Models\SiteType::Wordpress)
        @disallowed {
            path /xmlrpc.php
            path *.sql
