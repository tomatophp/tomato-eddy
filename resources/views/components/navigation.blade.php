    ...
    <nav class="bg-white border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-4 md:space-x-5 lg:space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('accounts.all')" :active="request()->routeIs('accounts*')">
                            {{ __('Accounts') }}
                        </x-nav-link>

                        <x-nav-link :href="route('activities.all')" :active="request()->routeIs('activities*')">
                            {{ __('Activities') }}
                        </x-nav-link>

                        <x-nav-link :href="route('servers.tags.index')" :active="request()->routeIs('tags*')">
                            {{ __('Tags') }}
                        </x-nav-link>
        ...
        <div :class="{'block': mobileNavigation.open, 'hidden': ! mobileNavigation.open}" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('accounts.all')" :active="request()->routeIs('accounts*')">
                    {{ __('Accounts') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('activities.all')" :active="request()->routeIs('activities*')">
                    {{ __('Activities') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('servers.tags.index')" :active="request()->routeIs('tags*')">
                    {{ __('Tags') }}
                </x-responsive-nav-link>
