...
use TomatoPHP\TomatoEddy\Infrastructure\Entities\Server;
...
use TomatoPHP\TomatoEddy\Infrastructure\Interfaces\HasCredentials;
...
class HetznerCloud implements ServerProvider, HasCredentials
{
     ...
     * @return \TomatoPHP\TomatoEddy\Infrastructure\Entities\Image The mapped Image.
     */
     ...
     *
     * @return \TomatoPHP\TomatoEddy\Infrastructure\Entities\SshKey|null
     */
     ...
     *
     * @return \TomatoPHP\TomatoEddy\Infrastructure\Entities\SshKey
     */
    ...
    public function restartServer(string $id): void
    {
        $restart = $this->http->post(self::API_URL."servers/{$id}/actions/reboot", [
            'id' => (int) $id,
        ]);
    }

    public function stopServer(string $id): void
    {
        $this->http->post(self::API_URL."servers/{$id}/actions/poweroff", [
            'id' => (int) $id,
        ]);
    }

    public function startServer(string $id): void
    {
        $this->http->post(self::API_URL."servers/{$id}/actions/poweron", [
            'id' => (int) $id,
        ]);
    }
     ...
     * @return ?array
     */
    public function createServerVolume(string $id, string $name, int $size): ?array
    {
    ...
    public function deleteServerSSH(string $id): void
    {
        $this->http->delete(self::API_URL."ssh_keys/{$id}");
    }
}
